        ...
        <Row className="mb-4">
          <Col md={4} className="mb-3">
            <Card className="text-center">
              <Card.Body>
                <h3 className="text-primary">{dashboardData.application_count}</h3>
                <p className="card-text text-muted">Applications Sent</p>
              </Card.Body>
            </Card>
          </Col>
          <Col md={4} className="mb-3">
            <Card className="text-center">
              <Card.Body>
                <h3 className="text-primary">{dashboardData.saved_jobs?.length || 0}</h3>
          ...
          <Col md={4} className="mb-3">
            <Card className="text-center">
              <Card.Body>
                <h3 className="text-primary">{dashboardData.recent_activities?.length || 0}</h3>
                <p className="card-text text-muted">Recent Activities</p>
              </Card.Body>
            </Card>
          </Col>
        </Row>
      ...
      <Row>
        ...
        <Col md={4} className="mb-4">
          <Card className="h-100">
            ...
            <Card.Body>
              {dashboardData && dashboardData.application_count > 0 ? (
                <>
