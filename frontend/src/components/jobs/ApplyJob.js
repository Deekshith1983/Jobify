...
const ApplyJob = () => {
  ...
  if (loading) {
    return <Container className="mt-5 text-center"><Spinner animation="border" /> <p>Loading...</p></Container>;
  }
            ...
            <Card.Body>
              ...
              <Form onSubmit={handleSubmit}>
                ...
                <Button variant="primary" type="submit" disabled={submitting}>
                  {submitting ? <><Spinner as="span" animation="border" size="sm" role="status" aria-hidden="true" /> Submitting...</> : 'Submit Application'}
                </Button>
              </Form>
            </Card.Body>
          </Card>
